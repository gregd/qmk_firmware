...
#        ifdef GD_MOVE
    ...
    GDM(GD_GO_SLINE, SS_TAP(X_HOME));
    GDM(GD_GO_ELINE, SS_TAP(X_END));
    GDM(GD_GO_SDOC, IMCTL(X_HOME));
    GDM(GD_GO_EDOC, IMCTL(X_END));
    ...
    GDM(GD_NLINE_N, SS_TAP(X_DOWN) SS_TAP(X_DOWN) SS_TAP(X_DOWN) SS_TAP(X_DOWN) SS_TAP(X_DOWN) SS_TAP(X_DOWN) SS_TAP(X_DOWN) SS_TAP(X_DOWN));
    GDM(GD_PLINE_N, SS_TAP(X_UP) SS_TAP(X_UP) SS_TAP(X_UP) SS_TAP(X_UP) SS_TAP(X_UP) SS_TAP(X_UP) SS_TAP(X_UP) SS_TAP(X_UP));
