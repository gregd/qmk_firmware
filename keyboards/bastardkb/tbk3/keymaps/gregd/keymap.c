...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT_split_4x6_3( \
        GD_QWERTY, KC_TILD,  KC_CIRC,  KC_PERC, GD_ARROW, GD_FARROW, /**/ KC_NO,         BABL_DEL_2LNS, BABL_DEL_2LNE, KC_NO,         KC_NO,      KC_NO, \
	...
	[_IDE] = LAYOUT_split_4x6_3( \
        ...
        _______, KC_NO, KC_NO, KC_NO, BABL_IDE_FINF, KC_NO, /**/ KC_NO, BABL_IDE_WIN_FTREE, KC_NO, KC_NO, KC_NO, KC_NO, \
