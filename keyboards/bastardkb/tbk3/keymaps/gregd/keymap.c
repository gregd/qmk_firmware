...
[_NAV] = LAYOUT_split_4x6_3( \
  GD_QWERTY, KC_TILD,  KC_CIRC,  KC_PERC, GD_ARROW, GD_FARROW,              /**/ GD_DEL_LINE, GD_DEL_2LNS, GD_DEL_2LNE, GD_I_DUP_LINE,   KC_WWW_HOME,    KC_MY_COMPUTER, \
...
[_SYMBOLS] = LAYOUT_split_4x6_3( \
  GD_QWERTY,        KC_F1,          KC_F2,           KC_F3,            KC_F4,          KC_F5,        /**/ KC_F6,      KC_F7,     KC_F8,       KC_F9,     GD_SCR_CAP_SEL, GD_SCR_CAP_FULL, \
  GD_APP_SAVE,    GD_WIN_NEXT,  GD_BR_URL_BAR, GD_BR_NEW_TAB,  GD_FIND,      GD_REPLACE, /**/ KC_1,       KC_2,      KC_3,        KC_4,      KC_5,             KC_F10, \
  GD_BR_ZOOM_IN,  GD_APP_NEXT,  GD_ALT_TAB,      GD_BR_NEXT_TAB, GD_FIND_NEXT, GD_UNDO,    /**/ KC_6,       KC_7,      KC_8,        KC_9,      KC_0,             KC_F11, \
  GD_BR_ZOOM_OUT, GD_CLOSE_APP, GD_BR_CL_TAB,  GD_BR_PREV_TAB, GD_FIND_PREV, GD_REDO,    /**/ GD_FARROW,  GD_ARROW,  GD_ABRACKET, GD_HDIR,   GD_UDIR,          KC_F12, \
