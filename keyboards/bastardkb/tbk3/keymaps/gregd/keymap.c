...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYMBOLS] = LAYOUT_split_4x6_3( \
        ...
        BABL_WINDOW_NEXT, BABL_SWITCH_APP_NEXT, BABL_APP_SAVE,      BABL_BR_NEW_TAB,  BABL_FIND,      BABL_FIND_REPLACE,  /**/ KC_1,  KC_2,  KC_3,  KC_4,  KC_5,   KC_F11, \
        BABL_BR_ZOOM_IN,  GD_ALT_TAB,           BABL_BR_URL_BAR,    BABL_BR_NEXT_TAB, BABL_FIND_NEXT, BABL_UNDO,          /**/ KC_6,  KC_7,  KC_8,  KC_9,  KC_0,   KC_F12, \
        BABL_BR_ZOOM_OUT, BABL_CLOSE_APP,       BABL_BR_CLOSE_TAB,  BABL_BR_PREV_TAB, BABL_FIND_PREV, BABL_REDO,          /**/ GD_FARROW, GD_ARROW, GD_ABRACKET, GD_HDIR, GD_UDIR, KC_NO, \
	...
	[_IDE] = LAYOUT_split_4x6_3( \
        ...
        _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, /**/ KC_NO, BABL_IDE_WIN_FTREE, KC_NO, KC_NO, KC_NO, KC_NO, \
        _______, KC_NO, KC_NO, KC_NO, BABL_IDE_FINF, KC_NO, /**/ KC_NO, BABL_IDE_QDOC, KC_NO, KC_NO, KC_NO, KC_NO, \
