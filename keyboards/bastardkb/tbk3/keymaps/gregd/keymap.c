...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_split_4x6_3( \
    ...
    KC_LEAD,       KC_1,       KC_2,    KC_3,    KC_4,      KC_5,                       /**/ KC_6,          KC_7,         KC_8,        KC_9,    KC_0,     GD_RESET, \
    OSM(MOD_RALT), KC_Q,       KC_W,    KC_E,    KC_R,      KC_T,                       /**/ KC_Y,          KC_U,         KC_I,        KC_O,    KC_P,     KC_PEQL, \
  ...
  [_SYMBOLS] = LAYOUT_split_4x6_3( \
    ...
    GD_APP_SAVE,  GD_WIN_NEXT,  GD_B_URL_BAR,  GD_B_NEW_TAB,  GD_FIND,   GD_REPLACE,    /**/ KC_1,       KC_2,      KC_3,        KC_4,      KC_5,           KC_F10, \
    GD_WIN_CEN,   GD_APP_NEXT,  GD_ALT_TAB,    GD_B_NEXT_TAB, GD_FNEXT,  GD_UNDO,       /**/ KC_6,       KC_7,      KC_8,        KC_9,      KC_0,           KC_F11, \
    GD_WIN_HIDE,  GD_CLOSE_APP, GD_B_CL_TAB,   GD_B_PREV_TAB, GD_FPREV,  GD_REDO,       /**/ GD_FARROW,  GD_ARROW,  GD_ABRACKET, GD_HDIR,   GD_UDIR,        KC_F12, \
    \
