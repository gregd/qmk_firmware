...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_POLISH] = LAYOUT_split_4x6_3( \
        RALT(KC_X), RALT(KC_A), RALT(KC_S), RALT(KC_E), RALT(KC_Z), RALT(KC_C), /**/ GD_PL_DZ, RALT(KC_L), RALT(KC_N), RALT(KC_O), GD_PL_CZ, GD_PL_RZ, \
	...
	[_NAV] = LAYOUT_split_4x6_3( \
        _______, BABL_CLOSE_APP,  KC_NO,              GD_NAV,              GD_QWERTY,      GD_POLISH, /**/ BABL_DEL_TO_LINE_START, BABL_DEL_LEFT_WORD, BABL_DEL_RIGHT_WORD, BABL_DEL_TO_LINE_END, BABL_DEL_LINE, _______, \
        _______, BABL_REDO,       BABL_WINDOW_NEXT,   BABL_SWITCH_APP_NEXT, GD_ALT_TAB,     BABL_DEL_TO_LINE_END, /**/ BABL_GO_START_LINE, BABL_GO_LEFT_WORD, BABL_GO_RIGHT_WORD, BABL_GO_END_LINE, BABL_PASTE, GD_LOCK_SHIFT, \
        _______, BABL_SELECT_ALL, BABL_FIND_PREV,     BABL_FIND_NEXT,       BABL_FIND,      BABL_DEL_LEFT_WORD, /**/ KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, BABL_COPY, _______, \
        _______, BABL_UNDO,       BABL_CUT,           BABL_COPY,            BABL_PASTE,     BABL_DEL_TO_LINE_START, /**/ BABL_GO_START_DOC, BABL_PGDN,  BABL_PGUP, BABL_GO_END_DOC, BABL_CUT, _______, \
