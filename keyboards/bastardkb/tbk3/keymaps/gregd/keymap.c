...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYMBOLS] = LAYOUT_split_4x6_3( \
        ...
        BABL_WINDOW_NEXT, BABL_APP_SAVE,  BABL_BR_URL_BAR,    BABL_BR_NEW_TAB,  BABL_FIND,      BABL_FREPLACE,  /**/ KC_1,       KC_2,      KC_3,        KC_4,      KC_5,             KC_F10, \
	...
	[_IDE] = LAYOUT_split_4x6_3( \
        RESET,   GD_RESET,        KC_NO,             KC_MPRV,           KC_MPLY,           KC_MNXT,            /**/ BABL_IDE_WIN_STR,   BABL_IDE_WIN_GCOM,  BABL_IDE_WIN_GHIS, BABL_IDE_GO_LINE,    KC_NO,             GD_INFO, \
