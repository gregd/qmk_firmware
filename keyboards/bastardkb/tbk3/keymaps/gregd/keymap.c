...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT_split_4x6_3( \
        ...
        BABL_BROWSER_RELOAD, BABL_IDE_FILE_FIND, BABL_IDE_WIN_FTREE, BABL_IDE_QUICK_DOC, BABL_IDE_GO_DEF, BABL_IDE_GO_BACK, /**/ BABL_GO_END_DOC, BABL_PGDN,  BABL_PGUP, BABL_GO_START_DOC, BABL_CUT, _______, \
        KC_APP, BABL_DEL_LEFT_WORD, KC_DEL, /**/ BABL_IDE_COMPLETION, BABL_IDE_NEW_LINE, BABL_IDE_DUP_LINE),
