...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT_split_4x6_3( \
        GD_QWERTY, KC_TILD,  KC_CIRC,  KC_PERC, GD_ARROW, GD_FARROW, /**/ BABL_DEL_LINE, BABL_DEL_2LNS, BABL_DEL_2LNE, BABL_IDE_DUP_LINE, KC_NO,  KC_NO, \
	...
	[_SYMBOLS] = LAYOUT_split_4x6_3( \
        GD_QWERTY, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                                                                     /**/ KC_F6, KC_F7, KC_F8, KC_F9, KC_NO, KC_NO, \
	...
	[_IDE] = LAYOUT_split_4x6_3( \
        ...
        _______, KC_NO, KC_NO, BABL_IDE_FIXES, BABL_IDE_FINF, BABL_IDE_WIN_SEA, /**/ BABL_IDE_REL_FILE, BABL_IDE_QDOC, BABL_IDE_PREV_FN, BABL_IDE_REC_FILE, BABL_IDE_REFACTOR, BABL_IDE_COL_MODE, \
        _______, KC_NO, KC_NO, BABL_IDE_COMPLETE, BABL_IDE_FIND_ALL, BABL_IDE_WIN_FTREE, /**/ BABL_IDE_USAGES, BABL_IDE_GO_DEF, BABL_IDE_NEXT_FN, BABL_IDE_GO_LAST_ED, BABL_IDE_RENAME, BABL_IDE_REFORMAT, \
        _______, KC_NO, KC_NO, KC_NO, BABL_IDE_RUN_SEL, BABL_IDE_WIN_RUN,                 /**/ BABL_IDE_GO_FWD, BABL_IDE_GO_BACK, BABL_IDE_REL_SYM, BABL_IDE_REC_LOC, BABL_IDE_COMMENT, BABL_IDE_TGL_CASE, \
